        ...
        <div>
              ...
              @case("PENDIENTE")
                ...
                <p align="center">
                  <form action="{{ route('pedidos.update',$pedido->id) }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-danger">Aceptar Pedido</button>
                  </form>
                  <br>
                  <form action="{{ route('pedidos.update',$pedido->id) }}" method="POST">
                    @csrf
            ...
            <form class="" action="{{env('APP_URL')}}/iniciarchat" method="post">
              ...
              <button type="submit" class="btn btn-primary">
                <i class="zmdi zmdi-comments"></i> Dejar mensaje
              </button>
...
<div class="row">
  <div class="col-md-6 col-lg-6 bg-secondary">
      ...
      <table class="table table-bordered">
        ...
        <tr class="bg-white">
          <td class="product-name">
            ...
            <h4 style="color:red">{{$pedido->moneda}} {{$detalle->precio}}</h4>
            <hr>
            @php $totalcomplementos=0; @endphp
            @foreach($complementos as $complemento)
              @if($complemento->pedidodetalle==$detalle->id)
                <font color="black">{{$complemento->nombre}}</font> - <font color="red">{{$pedido->moneda}} {{$complemento->precio}}</font><hr>
